...
# Example usage
bib_file_path = 'data/references/oc_no_duplicates.bib'  # Change to your BibTeX file path
excel_file_path = 'data/cci/cci_oc_papers.xlsx'  # Change to your Excel file path
